  ...
  <div class="view-container">
    ...
    <div class="tab-content">
      ...
      <div v-if="activeTab === 'trace4'" class="retro-card trace-card">
        ...
        <p><strong>Description :</strong> La trace 4.1 présente le <span class="hl-cyan">Modèle Logique de Données (MLD) qui distingue visuellement les tables existantes (rose) et les tables créées pour le module (bleu)</span>. Les nouvelles tables ont été nommées et typées en cohérence avec les conventions de la base Oracle existante, pour assurer la modélisation en base de données pérenne et la maintenabilité par l'équipe après ma période d'alternance.</p>
