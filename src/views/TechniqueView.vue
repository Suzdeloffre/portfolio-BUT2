  ...
  <div class="view-container">
    ...
    <div class="tab-content">
      ...
      <div v-if="activeTab === 'trace4'" class="retro-card trace-card">
        ...
        <p><strong>Savoir-faire illustrés :</strong> <span class="hl-cyan">Concevoir et intégrer de nouvelles tables dans une base de données existante, justifier des choix de modélisation en cohérence avec l'existant</span>.</p>
        <p><strong>Description :</strong> La trace 4.1 présente le Modèle Logique de Données (MLD) qui distingue visuellement les tables existantes (rose) et les tables créées pour le module (bleu). <span class="hl-green">Les nouvelles tables ont été nommées et typées en cohérence avec les conventions de la base Oracle existante, pour assurer la modélisation en base de données pérenne et la maintenabilité par l'équipe après ma période d'alternance.</span></p>
